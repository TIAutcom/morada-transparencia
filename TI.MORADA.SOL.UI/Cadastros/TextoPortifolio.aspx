<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TextoPortifolio.aspx.cs" Inherits="TI.MORADA.SOL.UI.Cadastros.TextoPortifolio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <link href="../Cadastros/Css/external/google-code-prettify/prettify.css" rel="stylesheet">
        <link href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/css/bootstrap-combined.no-icons.min.css" rel="stylesheet">
        <link href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/css/bootstrap-responsive.min.css" rel="stylesheet">
        <link href="http://netdna.bootstrapcdn.com/font-awesome/3.0.2/css/font-awesome.css" rel="stylesheet">
        <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
        <script src="../Cadastros/Css/external/jquery.hotkeys.js"></script>
        <script src="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/js/bootstrap.min.js"></script>
        <script src="../Cadastros/Css/external/google-code-prettify/prettify.js"></script>
        <link href="../Cadastros/Css/index.css" rel="stylesheet">
        <script src="../Cadastros/Css/bootstrap-wysiwyg.js"></script>
    </head>
    <body>
    ...
    * https://github.com/mindmup/bootstrap-wysiwyg/blob/master/README.md#customising-
	--->
        ...
        <a href="https://github.com/mindmup/bootstrap-wysiwyg/">&nbsp;</a><div id="fb-root"></div>
        <script>
